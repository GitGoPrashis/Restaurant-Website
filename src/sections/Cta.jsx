...
const floatingDishes = [
  ...
  {src: "/assets/dish4.png", alt: "dish4", className:" bottom-6 right-4 md:bottom-10 md:right-[10%] lg:right-[14%]" }
]
    ...
    <section id='cta' className=' relative overflow-hidden bg-orange-500 px-6 flex flex-col justify-center items-center min-h-100 md:min-h-110 mt-44'>
      <div className=' absolute inset-0 w-full max-w-7xl mx-auto pointer-events-none'>
       ...
       <div className=' relative z-10 text-center max-w-2xl mx-auto'>
        <Animated>
          <h1 className=' text-3xl md:text-[40px] font-bold text-white font-urbanist text-balance'>
           Ready for a Delicious Experience?
          </h1>
        </Animated>
        <Animated y={20} delay={0.2}>
         <p className=' mt-4 text-white max-w-sm mx-auto'>
          Gather your loved ones and experience the authentic taste of Nepal at Bhojan Bhomi. From traditional favorites to delicious modern dishes, there's something for everyone.
