    ...
    return (
        ...
        <section id='features' className=' px-auto mt-44'>
            <div className=' text-center mb-16'>
                <Animated delay={0.2}>
                    <p className=' text-orange-500 font-medium uppercase mb-3.5'>
                        ...
                        More than just food, we create a dining experience filled with authentic flavors, quality ingredients, and warm hospitality.
                    </p>
                </Animated>
                <Animated>
            ...
            <div className=' flex flex-col md:flex-row items-center justify-between gap-14 max-w-7xl mx-auto'>
               ...
               <Animated x={50} y={0}>
                <img src="/assets/about.png" alt="chef" className=' w-full max-w-sm h-111 object-cover rounded-3xl' />
