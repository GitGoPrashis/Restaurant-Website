    ...
    <section id='booking-process' className=' px-auto mt-44'>
      <div className='max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-25'>
        ...
        <div className='text-center md:text-left'>
          <Animated delay={0.2}>
            <p className=' text-orange-500 font-medium uppercase mb-4'>Reserve Your Table, Savor the Moment</p>

          </Animated>
          <Animated delay={0.2}>
            <h2 className=' text-4xl md:text-5xl mb-16'> Get ready for a memorable dining experience at Bhojan Bhumi.</h2>
